    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>
                        {{$vacancy->title}} <x-vacancies.status-badge :status="$vacancy->status"/></h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#vacancy-show" data-toggle="tab">Просмотр</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#vacancy-edit" data-toggle="tab">Редактировать</a>
                                </li>
                            </ul>
                        </div> {{-- /.card-header --}}
                        <div class="card-body">
